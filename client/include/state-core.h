...
#include "icons-material-design-icons.h"
#include <cmath>
#include <sstream>
#include <cstdio>
#include <cstdint>
...
struct StateCore {
    ...
    void drawCard(PlayerIndex playerIndex, CardIndex cardIndex, ImVec2 pos, ImVec2 dir);

    void drawCardBack(const ImVec2 &pos, const ImVec2 &dir);
    void drawHand(PlayerIndex playerIndex, ImVec2 pos, const ImVec2 &dir);
    void drawToepButton(const ImVec2 &pos, const ImVec2 &dir);
    void drawCallFoldButton(const ImVec2& pos, const ImVec2& dir);
    void drawConnectButton();

    void cardsInPlay(ImVec2 pos);

    void drawPlayer(PlayerIndex playerIndex, const ImVec2 &dir);
